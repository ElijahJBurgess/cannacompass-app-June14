  ...
  useEffect(() => {
    const processQuizData = async () => {
      try {
        ...
        const matchedProducts = await getMatchingProducts(responsesData.responses);
        
        // Store results in localStorage for results page
        localStorage.setItem('quiz_results', JSON.stringify(matchedProducts));
    ...
    // Start processing after a short delay to show loading animation
    const timer = setTimeout(processQuizData, 2000);
